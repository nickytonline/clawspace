  ...
  return (
    <>
      <button
        ...
        className="inline-flex hover:text-red-600 hover:dark:text-red-400 focus:text-red-600 focus:dark:text-red-400 focus:outline-none transition-colors"
        ...
        <div className="p-4 border-b border-secondary">
          <div className="relative">
            ...
            <input
              ...
              className="w-full pl-10 pr-4 py-3 bg-secondary rounded-md focus:outline-none focus:ring-2 focus:ring-red-600 text-lg"
              value={query}
                  ...
                  <li key={result.url}>
                    <a
                      ...
                      className={`block p-4 rounded-lg transition-colors border outline-none ${
                        isSelected
                          ? "bg-secondary border-red-600/30 dark:border-red-400/30 ring-1 ring-red-600/20 dark:ring-red-400/20"
